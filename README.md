...
7. Add symbols
    ...
    * replace `(<groundspeak:long_description[^<]*Teil des Altenauer Herzwegs[^<]*<\/groundspeak:long_description>)([^<]*)((<\/?[^c][^<]*)+)(<cgeo:cacheExtension>[^<]*)<cgeo:assignedEmoji>[^<]*<\/cgeo:assignedEmoji>` with `\1\2\3\4\5<cgeo:assignedEmoji>128147</cgeo:assignedEmoji>`
